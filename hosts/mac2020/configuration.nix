...

{
  ...
  networking.hostName = lib.mkDefault "mac2020"; # Define your hostname.
  # Use the systemd-boot EFI boot loader.
  boot.loader.systemd-boot.enable = true;
  boot.loader.efi.canTouchEfiVariables = true;
  # Enable necessary firmware for Wi-Fi
  hardware.firmware = [ pkgs.linuxFirmware ];

  # Enable NetworkManager for managing network connections
  networking.networkmanager.enable = true;

  # Include Apple SPI driver for keyboard and trackpad support
  boot.extraModulePackages = [ pkgs.applespi ];
  services.udev.packages = [ pkgs.applespi ];
